<template>
    ...
    <section class="feedback__wrap">
        <video class="feedback__video" autoplay loop muted src="img/video-bg.mp4"></video>
        <div class="container">
            <div class="feedback">
                <div class="reviews">
                    <div class="reviews__image"></div>
                    <p>&laquo;Vestibulum quis porttitor dui! Quisque <wbr> viverra nunc&nbsp;mi, a&nbsp; <i>pulvinar purus condimentum&raquo;</i> </p>
                </div>
                <div class="subscribe">

                    <h4 class="subscribe__header"> <span>subscribe</span> for our newletter and promotion</h4>
                    <form class="subscribe__form">
                        <input type="email" placeholder="enter your email" class="subscribe__input"> <button class="subscribe__button">Subscribe</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="page-footer__wrap">
            <p class="page-footer__copyright">&copy;&nbsp;2021 Brand All Rights Reserved.</p>
...
<script src="ws-footer.js"></script>